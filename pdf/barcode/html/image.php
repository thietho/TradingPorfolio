...
if(isset($_GET['code']) && isset($_GET['t']) && isset($_GET['r']) && isset($_GET['text']) && isset($_GET['f']) && isset($_GET['o']) && isset($_GET['a1']) && isset($_GET['a2'])){
	...
	if(include('../class/'.$_GET['code'].'.barcode.php')){
		...
		for($i=0;$i<10;$i++)
		{
			...
			if(!empty($_GET['a2']))
			$code_generated = new $_GET['code']($_GET['t'],$color_black,$color_white,$_GET['r'],$code,$_GET['f'],$_GET['a1'],$_GET['a2']);
			elseif(!empty($_GET['a1']))
				$code_generated = new $_GET['code']($_GET['t'],$color_black,$color_white,$_GET['r'],$code,$_GET['f'],$_GET['a1']);
			else
				$code_generated = new $_GET['code']($_GET['t'],$color_black,$color_white,$_GET['r'],$code,$_GET['f']);
			
			$drawing = new FDrawing(1024,1024,"../image/".$code.'.png',$color_white);
			$drawing->init();
