...
class PDF extends tFPDF
{
    ...
    function createtemplate()
    {
        ...
        $this->SetXY($this->papdingleft+19, 49);
        $this->Cell(30,65,$this->data['setting']['currencyprefix'].$string->numberFormate($this->data['amount']).$this->data['setting']['currencysubfix'],0,1);
        $this->SetDrawColor(98,98,98);
        ...
        $this->SetXY($this->papdingleft+19, 49);
        $this->Cell(30,75,"(In words:".$string->doc_so($this->data['amount']).")",0,1);
        $this->setFooter(100);
    }
    ...
    function createPage()
    {
        ...
        $this->SetTextColor(0, 0, 0);
        $this->SetXY(6, 30);
        $this->Cell(0,5,"Payment Receipt",0,1);
