...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2018 at 05:30 PM
...
INSERT INTO `accountstock` (`id`, `accountid`, `openat`, `buyfee`, `salefee`, `marginrate`, `cardid`, `status`, `depositfee`) VALUES
(1, '8732', 'C1469642015', 0.15, 0.15, 0.029, 'C1469642014', 'active', 5000),
(2, '1234', 'C1469642015', 0.15, 0.2, 0.02, 'C1469642014', 'active', 5000),
(3, '1111', 'C1469642017', 0.2, 0.3, 0.03, 'C1469642016', 'active', 10000),
(4, '22222', 'C1469642017', 0.2, 0.3, 0.03, 'C1469642014', 'active', 8000),
(5, '3333', 'C1469642015', 0.2, 0.3, 0.02, 'C1469642014', 'active', 5000),
(6, '5555', 'C1469642015', 0.2, 0.2, 0.02, 'C1469642014', 'active', 10000),
(7, '6666', 'C1469642017', 0.2, 0.2, 0.02, 'C1469642016', 'active', 10000),
(8, '44444', 'C1469642017', 0.3, 0.2, 0.02, 'C1469642014', 'active', 5000);
...
(3, 'C1469642015', '', '', '', '', 'Kis Việt Nam', '', '', '', '', '342342', '', '', '', 0, '', '2018-05-11 10:11:31', '2018-05-11 10:11:31', '', '', '0000-00-00 00:00:00', '', 'company', 0, 0, '', '', '', '', '', '', '', '', '0000-00-00 00:00:00'),
(4, 'C1469642016', '', '', '', '', 'Trần văn B', '', '', '', '', 'e2r232', '', '', '', 0, '', '2018-06-06 20:19:50', '2018-06-06 20:19:50', '', '', '0000-00-00 00:00:00', '', 'customer', 0, 0, '', '', '', '', '', '', '', '', '0000-00-00 00:00:00'),
(5, 'C1469642017', '', '', '', '', 'TechCom Stock', '', '', '', '', '242342', '', '', '', 0, '', '2018-06-06 20:20:21', '2018-06-06 20:20:21', '', '', '0000-00-00 00:00:00', '', 'company', 0, 0, '', '', '', '', '', '', '', '', '0000-00-00 00:00:00');
...
(2, 'C1469642015', 'Default', '', '', '', '', '0', '', '', ''),
(3, 'C1469642016', 'Default', '', '', '', '', '0', '', '', ''),
(4, 'C1469642017', 'Default', '', '', '', '', '0', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `dividendcash`
--

CREATE TABLE IF NOT EXISTS `dividendcash` (
`id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `dividendcash`
--

INSERT INTO `dividendcash` (`id`, `receivedate`, `deadline`, `symbol`, `accountid`, `amount`, `notes`, `createdate`, `createby`, `updatedate`, `updateby`, `deletedate`, `deleteby`) VALUES
(1, '2018-07-27', '2018-08-15', 'CSM', '8732', 5000000, 'à ưewe', '2018-07-27 20:46:15', 'admin', '2018-07-27 21:00:21', 'admin', '0000-00-00 00:00:00', '');

-- --------------------------------------------------------

--
-- Table structure for table `dividendstock`
--

CREATE TABLE IF NOT EXISTS `dividendstock` (
`id` bigint(20) NOT NULL,
  `receivedate` date NOT NULL,
  `deadline` date NOT NULL,
  `symbol` varchar(50) NOT NULL,
...
--
-- Dumping data for table `dividendstock`
--

INSERT INTO `dividendstock` (`id`, `receivedate`, `deadline`, `symbol`, `accountid`, `transactionid`, `price`, `dividendrate`, `quantity`, `quantityallowbuy`, `quantityallowreceive`, `notes`, `createdate`, `createby`, `updatedate`, `updateby`, `deletedate`, `deleteby`) VALUES
(1, '2018-07-27', '2018-08-08', 'KPF', '1111', 'B201807005', 5000, 10, 2000, 6000, 3000, 'fg ểtrefwe', '2018-07-27 21:43:25', 'admin', '2018-07-27 22:30:31', 'admin', '0000-00-00 00:00:00', '');
...
INSERT INTO `invoice` (`id`, `invoiceid`, `invoicedate`, `transactionid`, `marginid`, `dividendid`, `invoicetype`, `amount`, `notes`, `createdate`, `createby`, `updatedate`, `updateby`, `deletedate`, `deleteby`) VALUES
(1, 'INC20180600001', '2018-06-24', '', 0, 0, 'INC', 200000000, 'Nộp tiền mua CK', '2018-06-24 12:46:59', 'admin', '2018-06-24 13:24:01', 'admin', '0000-00-00 00:00:00', ''),
(2, '', '2016-06-28', '', 0, 0, 'EXP', 110265150, 'Mua cổ phiếu CSM', '2018-06-24 13:06:25', 'admin', '2018-06-24 13:06:25', 'admin', '2018-06-24 13:09:44', 'admin'),
(3, '', '2016-06-28', '', 0, 0, 'EXP', 110265150, 'Mua cổ phiếu CSM', '2018-06-24 13:08:23', 'admin', '2018-06-24 13:08:23', 'admin', '2018-06-24 13:09:39', 'admin'),
(4, 'EXP20180600001', '2016-06-28', 'B201805001', 0, 0, 'EXP', 110265150, 'Mua cổ phiếu CSM', '2018-06-24 13:09:50', 'admin', '2018-06-24 13:16:29', 'admin', '0000-00-00 00:00:00', ''),
(5, 'EXP20180600002', '2016-08-04', 'B201806002', 0, 0, 'EXP', 42764050, 'Mua cổ phiếu CSM', '2018-06-24 13:24:38', 'admin', '2018-06-24 13:24:38', 'admin', '0000-00-00 00:00:00', ''),
(6, 'EXP20180600003', '2016-11-07', 'B201806003', 0, 0, 'EXP', 107431906.5, 'Mua cổ phiếu CSM', '2018-06-24 13:24:57', 'admin', '2018-06-24 13:25:31', 'admin', '0000-00-00 00:00:00', ''),
(7, 'INC20180600002', '2016-11-09', 'S201806002', 0, 0, 'INC', 113767368.75, 'Bán cổ phiếu CSM', '2018-06-24 13:25:54', 'admin', '2018-06-24 13:25:54', 'admin', '0000-00-00 00:00:00', ''),
(8, 'INC20180600003', '2018-06-12', 'S201806003', 0, 0, 'INC', 87414675.6, 'Bán cổ phiếu CSM', '2018-06-24 13:26:11', 'admin', '2018-06-24 13:26:11', 'admin', '0000-00-00 00:00:00', ''),
(9, 'INC20180600004', '2017-02-10', 'S201806004', 0, 0, 'INC', 15654765, 'Bán cổ phiếu CSM', '2018-06-24 13:26:32', 'admin', '2018-06-24 13:26:32', 'admin', '0000-00-00 00:00:00', ''),
(10, 'INC20180700001', '2018-08-15', '', 0, 0, 'INC', 5000000, 'Nhận cổ tứ từ cổ phiếu CSM', '2018-07-27 20:59:14', 'admin', '2018-07-27 20:59:14', 'admin', '2018-07-27 21:00:12', 'admin'),
(11, 'INC20180700002', '2018-08-15', '', 0, 1, 'INC', 5000000, 'Nhận cổ tứ từ cổ phiếu CSM', '2018-07-27 21:00:21', 'admin', '2018-07-27 21:00:21', 'admin', '0000-00-00 00:00:00', ''),
(12, 'EXP20180700001', '2018-07-27', 'B201807001', 0, 0, 'EXP', 0, 'Mua cổ phiếu KPF', '2018-07-27 22:04:44', 'admin', '2018-07-27 22:04:44', 'admin', '2018-07-27 22:21:48', 'admin'),
(13, 'EXP20180700002', '2018-07-27', 'B201807002', 0, 0, 'EXP', 0, 'Mua cổ phiếu KPF', '2018-07-27 22:05:37', 'admin', '2018-07-27 22:05:37', 'admin', '2018-07-27 22:22:11', 'admin'),
(14, 'EXP20180700003', '2018-07-27', 'B201807003', 0, 0, 'EXP', 0, 'Mua cổ phiếu KPF', '2018-07-27 22:07:32', 'admin', '2018-07-27 22:07:32', 'admin', '2018-07-27 22:23:01', 'admin'),
(15, 'EXP20180700004', '2018-07-27', 'B201807004', 0, 0, 'EXP', 10000000, 'Mua cổ phiếu KPF', '2018-07-27 22:10:16', 'admin', '2018-07-27 22:10:16', 'admin', '2018-07-27 22:23:17', 'admin'),
(16, 'EXP20180700005', '2018-07-27', 'B201807005', 0, 0, 'EXP', 10000000, 'Mua cổ phiếu KPF', '2018-07-27 22:13:00', 'admin', '2018-07-27 22:30:31', 'admin', '0000-00-00 00:00:00', '');
...
INSERT INTO `transaction` (`id`, `transactionid`, `accountid`, `cardid`, `transactiondate`, `receivemoneydate`, `receivestockdate`, `symbol`, `name`, `type`, `volume`, `price`, `fee`, `tax`, `total`, `costofsale`, `profit`, `notes`, `createdate`, `createby`, `updatedate`, `updateby`, `deletedate`, `deleteby`) VALUES
(1, 'B201805001', '8732', 'C1469642014', '2016-06-28', '2016-06-30', '2016-07-01', 'CSM', 'Công ty Cổ phần Công nghiệp Cao su Miền Nam (HOSE)', 'B', 3000, 36700, 0.15, 0, 110265150, 0, 110265150, '2342', '2018-05-17 19:20:46', 'admin', '2018-06-24 13:16:29', 'admin', '0000-00-00 00:00:00', ''),
(2, 'B201806001', '8732', 'C1469642014', '2016-06-29', '2016-07-01', '2016-07-04', 'CSM', 'Công ty Cổ phần Công nghiệp Cao su Miền Nam (HOSE)', 'B', 1200, 0, 0.15, 0, 0, 36755.05, -44106060, 'Nhận cổ tức', '2018-06-06 19:11:00', 'admin', '2018-06-24 13:25:12', 'admin', '0000-00-00 00:00:00', ''),
(4, 'B201806002', '8732', 'C1469642014', '2016-08-04', '2016-08-08', '2016-08-09', 'CSM', 'Công ty Cổ phần Công nghiệp Cao su Miền Nam (HOSE)', 'B', 2000, 21350, 0.15, 0, 42764050, 26253.607142857, -9743164.2857143, 'ấ', '2018-06-08 21:58:01', 'admin', '2018-06-24 13:24:38', 'admin', '0000-00-00 00:00:00', ''),
(5, 'B201806003', '8732', 'C1469642014', '2016-11-07', '2016-11-09', '2016-11-10', 'CSM', 'Công ty Cổ phần Công nghiệp Cao su Miền Nam (HOSE)', 'B', 5220, 20550, 0.15, 0, 107431906.5, 24682.129032258, -21408807.048387, '', '2018-06-08 22:00:30', 'admin', '2018-06-24 13:25:31', 'admin', '0000-00-00 00:00:00', ''),
(6, 'S201806002', '8732', 'C1469642014', '2016-11-07', '2016-11-09', '2016-11-10', 'CSM', 'Công ty Cổ phần Công nghiệp Cao su Miền Nam (HOSE)', 'S', 5550, 20550, 0.15, 0.1, 113767368.75, 22807.452408056, -12813992.114711, '', '2018-06-08 22:02:44', 'admin', '2018-06-24 13:25:54', 'admin', '0000-00-00 00:00:00', ''),
(8, 'S201806003', '8732', 'C1469642014', '2018-06-08', '2018-06-12', '2018-06-13', 'CSM', 'Công ty Cổ phần Công nghiệp Cao su Miền Nam (HOSE)', 'S', 4520, 19388, 0.15, 0.1, 87414675.6, 22807.452408056, -15675009.284413, '', '2018-06-08 22:46:52', 'admin', '2018-06-24 13:26:11', 'admin', '0000-00-00 00:00:00', ''),
(9, 'S201806004', '8732', 'C1469642014', '2017-02-08', '2017-02-10', '2017-02-13', 'CSM', 'Công ty Cổ phần Công nghiệp Cao su Miền Nam (HOSE)', 'S', 760, 20650, 0.15, 0.1, 15654765, 22807.452408056, -1678898.8301228, '', '2018-06-08 22:56:05', 'admin', '2018-06-24 13:26:32', 'admin', '0000-00-00 00:00:00', ''),
(10, 'B201807001', '1111', 'C1469642016', '2018-07-27', '2018-07-31', '2018-08-01', 'KPF', 'Công ty Cổ phần Đầu tư tài chính Hoàng Minh (HOSE)', 'B', 2000, 5000, 0, 0, 0, 0, 0, '', '2018-07-27 22:04:44', 'admin', '2018-07-27 22:04:44', 'admin', '2018-07-27 22:21:48', 'admin'),
(11, 'B201807002', '1111', 'C1469642016', '2018-07-27', '2018-07-31', '2018-08-01', 'KPF', 'Công ty Cổ phần Đầu tư tài chính Hoàng Minh (HOSE)', 'B', 2000, 5000, 0, 0, 0, 0, 0, '', '2018-07-27 22:05:37', 'admin', '2018-07-27 22:05:37', 'admin', '2018-07-27 22:22:12', 'admin'),
(12, 'B201807003', '1111', 'C1469642016', '2018-07-27', '2018-07-31', '2018-08-01', 'KPF', 'Công ty Cổ phần Đầu tư tài chính Hoàng Minh (HOSE)', 'B', 2000, 5000, 0, 0, 0, 0, 0, '', '2018-07-27 22:07:31', 'admin', '2018-07-27 22:07:31', 'admin', '2018-07-27 22:23:01', 'admin'),
(13, 'B201807004', '1111', 'C1469642016', '2018-07-27', '2018-07-31', '2018-08-01', 'KPF', 'Công ty Cổ phần Đầu tư tài chính Hoàng Minh (HOSE)', 'B', 2000, 5000, 0, 0, 10000000, 0, 10000000, '', '2018-07-27 22:10:15', 'admin', '2018-07-27 22:10:15', 'admin', '2018-07-27 22:23:17', 'admin'),
(14, 'B201807005', '1111', 'C1469642016', '2018-07-27', '2018-07-31', '2018-08-01', 'KPF', 'Công ty Cổ phần Đầu tư tài chính Hoàng Minh (HOSE)', 'B', 2000, 5000, 0, 0, 10000000, 0, 10000000, '', '2018-07-27 22:13:00', 'admin', '2018-07-27 22:30:31', 'admin', '0000-00-00 00:00:00', '');
...
--
-- Indexes for table `dividendcash`
--
ALTER TABLE `dividendcash`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dividendstock`
--
ALTER TABLE `dividendstock`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `dividendcash`
--
ALTER TABLE `dividendcash`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `dividendstock`
--
ALTER TABLE `dividendstock`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
